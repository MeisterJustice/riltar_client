...
const DiscoverCategoryPc = lazy(() =>
  import("../../components/pc/DiscoverCategory")
);
const DiscoverCategoryMobile = lazy(() =>
  import("../../components/mobile/DiscoverCategory")
);
...
export default connect(mapStateToProps, { logout })(DiscoverCategory);
