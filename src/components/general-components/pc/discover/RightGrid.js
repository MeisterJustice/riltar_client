                  ...
                  <Box>
                    <Box ml={2}>
                      <Link
                        ...
                        className="link2"
                      >
                        <Box fontSize={18.5}>{product.title}</Box>
                      ...
                      >
                        <Box>
                          {product.isNegotiable && <Box>Negotiable</Box>}
                          <Box color="#B12704" fontWeight={600} mt={0.5}>
                            Only {product.quantity} item remaining in stock -
                            Order soon.
                          </Box>
                        </Box>
                        {product.user.firstName && (
                          <Box ml={10}>
                            <Box mt={1}>
                              Sold by; {product.user.firstName}{" "}
                            ...
                            {product.user.feedback > 0 && (
                              <Box mt={1}>
                                {product.user.feedback}% positive user feedback
                              </Box>
                            )}
                          </Box>
                        )}
