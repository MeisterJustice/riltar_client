...
const AlertDialogue = React.memo((props) => {
  return (
    <div>
      <Dialog
        open={props.open}
        onClose={!props.open2 ? props.handleClose : null}
        aria-labelledby="alert"
        aria-describedby="alert-description"
      >
        <DialogTitle style={{ backgroundColor: props.color }} id="alert">
        ...
        {!props.open2 ? (
          <DialogActions style={{ backgroundColor: props.color }}>
            <Button
